...
import { LogOut, Activity, Clock, Users, MessageSquare } from 'lucide-react'
...
export default function PatientLayout({
    ...
    const navItems = [
        { name: 'New AI Check', href: '/patient', icon: Activity },
        { name: 'History', href: '/patient/history', icon: Clock },
        { name: 'Available Doctors', href: '/patient/doctors', icon: Users },
        { name: 'Chats', href: '/patient/chats', icon: MessageSquare },
    ]
