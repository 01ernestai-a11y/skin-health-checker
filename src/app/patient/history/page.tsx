...
export default async function HistoryPage() {
        ...
        return (
            <Card className="max-w-3xl mx-auto border-dashed">
                <CardContent className="pt-10 pb-10 text-center text-slate-500">
                    You haven't completed any AI skin checks yet.
                </CardContent>
            </Card>
        )
    }
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <h2 className="text-2xl font-bold tracking-tight text-slate-900">Your Evaluation History</h2>
                ...
                <Card key={check.id} className="overflow-hidden">
                    <CardHeader className="bg-slate-50 border-b pb-4">
                        <div className="flex justify-between items-start">
                            <div>
                                <CardTitle className="text-lg">AI Health Check</CardTitle>
