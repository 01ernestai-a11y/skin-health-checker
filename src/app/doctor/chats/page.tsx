...
export default async function DoctorChatsPage() {
        ...
        return (
            <Card className="max-w-3xl mx-auto border-dashed">
                <CardContent className="pt-10 pb-10 text-center text-slate-500">
                    You don't have active consultations yet. Patients will appear here when they contact you.
                </CardContent>
            </Card>
        )
    }
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <h2 className="text-2xl font-bold tracking-tight text-slate-900">Patient Consultations</h2>
