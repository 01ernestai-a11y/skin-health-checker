...
export default async function DoctorChatRoomPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="max-w-3xl mx-auto h-[calc(100vh-12rem)] flex flex-col pt-2">
            <Link href="/doctor/chats" className="flex items-center text-sm text-slate-500 hover:text-slate-900 mb-4 transition-colors">
                <ChevronLeft className="w-4 h-4 mr-1" /> Back to Consultations
            </Link>
            ...
            <Card className="flex-1 flex flex-col border-0 shadow-sm ring-1 ring-slate-200 overflow-hidden">
                <CardHeader className="border-b bg-slate-50 py-4">
                    <CardTitle className="text-lg">Consultation Room</CardTitle>
                </CardHeader>
